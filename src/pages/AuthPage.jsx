            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-[11px] text-slate-400 mt-1 flex items-center gap-1">
                  ...
                  <span>Học sinh không cần Email, chỉ cần Mã do Giáo viên cấp để vào chơi ngay trong 3 giây.</span>
                </p>
              </div>

              {/* Quick Fill Student Codes */}
              <div className="p-3 rounded-xl bg-slate-900/80 border border-slate-800/80 space-y-2">
                <span className="text-[11px] font-bold text-slate-400 block uppercase tracking-wider">
                  Mã Học Sinh Thử Nghiệm Nhanh:
                </span>
                <div className="flex flex-wrap gap-2">
                  <button
                    type="button"
                    onClick={() => setStudentCode('HS602941')}
                    className="px-2.5 py-1 rounded-lg bg-indigo-600/20 hover:bg-indigo-600/40 border border-indigo-500/40 text-indigo-300 text-xs font-mono font-bold transition-all"
                  >
                    ⚡ HS602941 (Nam - Lớp 7)
                  </button>
                  <button
                    ...
                    className="px-2.5 py-1 rounded-lg bg-emerald-600/20 hover:bg-emerald-600/40 border border-emerald-500/40 text-emerald-300 text-xs font-mono font-bold transition-all"
                  >
                    ⚡ GV889102 (Cô Hà - Lớp 8)
                  </button>
                </div>
              </div>
            </div>
